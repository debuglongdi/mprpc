...
class GetFriendListsResponse :
 ...
 public:
  ...
  // repeated .fixbuf.User friend_lists = 2;
  int friend_lists_size() const;
  private:
  int _internal_friend_lists_size() const;
  public:
  void clear_friend_lists();
  ::fixbuf::User* mutable_friend_lists(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbuf::User >*
      mutable_friend_lists();
  private:
  const ::fixbuf::User& _internal_friend_lists(int index) const;
  ::fixbuf::User* _internal_add_friend_lists();
  public:
  const ::fixbuf::User& friend_lists(int index) const;
  ::fixbuf::User* add_friend_lists();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbuf::User > friend_lists_;
  ::fixbuf::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
inline ::fixbuf::User* GetFriendListsResponse::mutable_friend_lists(int index) {
  // @@protoc_insertion_point(field_mutable:fixbuf.GetFriendListsResponse.friend_lists)
...
GetFriendListsResponse::mutable_friend_lists() {
  // @@protoc_insertion_point(field_mutable_list:fixbuf.GetFriendListsResponse.friend_lists)
  return &friend_lists_;
}
inline const ::fixbuf::User& GetFriendListsResponse::_internal_friend_lists(int index) const {
  return friend_lists_.Get(index);
}
inline const ::fixbuf::User& GetFriendListsResponse::friend_lists(int index) const {
  // @@protoc_insertion_point(field_get:fixbuf.GetFriendListsResponse.friend_lists)
  return _internal_friend_lists(index);
}
inline ::fixbuf::User* GetFriendListsResponse::_internal_add_friend_lists() {
  return friend_lists_.Add();
}
inline ::fixbuf::User* GetFriendListsResponse::add_friend_lists() {
  // @@protoc_insertion_point(field_add:fixbuf.GetFriendListsResponse.friend_lists)
...
GetFriendListsResponse::friend_lists() const {
  // @@protoc_insertion_point(field_list:fixbuf.GetFriendListsResponse.friend_lists)
  return friend_lists_;
}
